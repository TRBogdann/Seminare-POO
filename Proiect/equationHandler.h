...
class EquationHandler
{
   ...
   friend std::ostream& operator<<(std::ostream &os,EquationHandler& handler);
   friend std::istream& operator>>(std::istream &os,EquationHandler& handler);

   static double powerOfX(char *str,int len,char unk);
